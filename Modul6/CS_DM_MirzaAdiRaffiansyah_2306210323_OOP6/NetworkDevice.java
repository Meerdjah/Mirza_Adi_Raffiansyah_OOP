...
public class NetworkDevice {
    ...
    public NetworkDevice(String modelName, String deviceName, String macAddress, String ipV4, String ipV6, int vlan, List<String> connections, List<Module> modules) {
